...
describe("TikTok caption overlay style", () => {
  it("styles Chinese captions, warning, potential states, and resize affordance", async () => {
    ...
    assert.match(source, /按每小时点赞量排序/);
    assert.match(source, /先按时间范围限制/);
    assert.match(source, /重新排序/);
    assert.match(source, /加载更多并排序/);
    assert.match(source, /更多条件/);
